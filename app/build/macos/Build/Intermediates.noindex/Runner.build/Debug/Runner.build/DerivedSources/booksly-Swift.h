...
#ifndef BOOKSLY_SWIFT_H
#define BOOKSLY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="booksly",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7booksly11AppDelegate")
...
SWIFT_CLASS("_TtC7booksly29BlurryContainerViewController")
...
SWIFT_CLASS("_TtC7booksly17MainFlutterWindow")
@interface MainFlutterWindow : NSWindow <NSWindowDelegate>
- (void)awakeFromNib;
